...
def ExecuteEventOnGraph(dcr,event):
    ...
    semantics.weak_execute(event,dcr)
    return dcr


test1 = createDCRgraph(test)
print(test1)
test2 = ExecuteEventOnGraph(test1,"A5")
print(test2)
test3 = ExecuteEventOnGraph(test2,"A13")
print(test3)
test4 = ExecuteEventOnGraph(test2,"A7")
print(test4)